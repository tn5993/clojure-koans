...
(meditations
  ...
  (= '(* (clojure.core/first koans.18-macros/form) (clojure.core/nth koans.18-macros/form 2)) (macroexpand '(infix-better (10 * 2))))

  "Things don't always work as you would like them to... "
  (= '(+ (clojure.core/first koans.18-macros/form)
         (clojure.core/nth koans.18-macros/form 2))
